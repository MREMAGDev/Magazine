...
?>
		...
		<meta charset="UTF-8">
  		...
  		<meta name="keywords" content="Contents Pagr, Free, MReMag,Magazine Model Trains, Model Railway, Model Railroad, News, Comment, Updates, Model Loco Database">
	...
	<body class="homepage">
		...
		<!-- Section One -->
                              <?php include('php/getcontents.php'); ?>
	<!-- Footer -->
		<div id="footer">
